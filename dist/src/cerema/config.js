...
export function parseChannel(raw) {
    ...
    const valid = ['chrome', 'canary', 'dev', 'beta'];
    if (!valid.includes(lower)) {
        throw new Error(`CDM_CHANNEL invalide: "${raw}". Valeurs acceptées: chrome, canary, dev, beta.`);
    }
    return lower;
}
/**
 ...
 */
export function resolveProfileDir(profileDir, channel) {
 ...
 */
export function getForcedFlags() {
    return {
